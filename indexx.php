...
<div id="wrapper">
    	...
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="customer.php" method="post" style="margin-bottom:none;">
						...
						$result = mysql_query("SELECT * FROM route WHERE type='$category'");
						while($row = mysql_fetch_array($result))
							{
								echo '<option value="'.$row['id'].'">';
								echo $row['route'].' :'.$row['price'];
								echo '</option>';
							}
						?>
						</select>
    ...
    <div id="featured">
        <div id="items">
            <div class="item"> <a href="main-course.php"><img src="xres/images/icon_01.png" alt="" /></a>
            ...
            <div class="item"> <a href="lodging.php"><img src="xres/images/icon_2.png" alt="" /></a>
            <h3><a href="lodging.php">Secure Payment</a></h3>
	...
	<div id="footer">
	<h4>(+91)7384251024 &bull; <a href="">UIT, Golapbag(North), Rajbati, Burdwan  </a></h4>
