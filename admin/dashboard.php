							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="center"><a rel="facebox" href="edit__user.php?id='.$row['id'].'">edit</a> | <a href="#" id="'.$row['transactionnum'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
